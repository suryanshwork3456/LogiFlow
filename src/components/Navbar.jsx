      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex gap-8 items-center font-semibold text-sm uppercase tracking-wide">
          <button
            ...
            className="text-[#555F6D] hover:text-[#FF5722] transition-colors pb-1 uppercase font-semibold text-sm tracking-wide cursor-pointer"
          >
            HOME
          </button>
        ...
        {/* Desktop buttons: Track Shipment + Get Started (both → /login) */}
        <div className="hidden md:flex items-center gap-4 text-sm font-bold">
          <button
            onClick={() => navigate('/login')}
            className="px-6 py-2 border-2 border-[#E0E0E0] text-[#555F6D] rounded-lg hover:border-[#FF5722] hover:text-[#FF5722] transition-all"
          >
            Track Shipment
          </button>
      ...
      {isOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-[#FFFFFF] shadow-lg border-t border-[#E0E0E0] p-6 flex flex-col gap-6 font-semibold uppercase tracking-wide">
          <button
            ...
            className={`${navItemClass('/')} border-b border-[#E0E0E0] text-left`}
          >
            HOME
          </button>
          ...
          <button
            ...
            className="text-left text-[#555F6D] hover:text-[#FF5722] transition-colors pb-2 border-b border-[#E0E0E0] uppercase font-semibold"
          >
            SOLUTIONS
          </button>
          ...
          <div className="flex flex-col gap-4 mt-4">
            {/* Mobile Track Shipment → /login */}
            <button
              onClick={() => {
                setIsOpen(false);
                navigate('/login');
              }}
              className="py-3 w-full border-2 border-[#E0E0E0] text-[#555F6D] text-center rounded-lg hover:border-[#FF5722] hover:text-[#FF5722] transition-all"
            >
              Track Shipment
            </button>
