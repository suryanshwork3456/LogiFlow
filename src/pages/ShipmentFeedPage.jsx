    ...
    <div className="min-h-screen flex flex-col pt-20 bg-[#F5F5F5]">
      ...
      <div className="bg-[#1A1A2E] py-16 px-6 md:px-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-white/60 mb-2 font-medium tracking-wide">Home / Shipment Feed</div>
          <h1 className="text-white text-[40px] md:text-[56px] font-bold leading-tight mb-4">Shipment Tracking Feed</h1>
          <p className="text-white/80 text-xl font-medium mb-6">Full visibility. Zero guesswork.</p>
          <div className="w-12 h-1 bg-[#FF5722]"></div>
        </div>
      </div>

      <main className="flex-grow max-w-7xl mx-auto px-6 md:px-10 py-10 md:py-16 w-full space-y-8">
